...
extern "C" __global__ void update_s(int offcomm,
                                    float2 *mipjp, float2 *mjpkp, float2 *M,
                                    float2 *mu,__prec2 *sxx,__prec2 *sxy,__prec2 *sxz,
...

{
    ...
    float2 lM = M(gidz,gidy,gidx);
    float2 lmipjp = mipjp(gidz,gidy,gidx);
    float2 lmjpkp = mjpkp(gidz,gidy,gidx);
    float2 lmu = mu(gidz,gidy,gidx);
...
#define lidx gidx
    ...
    lsxx=sub2(add2(lsxx,mul2(lM,add2(add2(vx_x2,vy_y2),vz_z2))),mul2(mul2(2.0,lmu),add2(vy_y2,vz_z2)));
    lsyy=sub2(add2(lsyy,mul2(lM,add2(add2(vx_x2,vy_y2),vz_z2))),mul2(mul2(2.0,lmu),add2(vx_x2,vz_z2)));
    lszz=sub2(add2(lszz,mul2(lM,add2(add2(vx_x2,vy_y2),vz_z2))),mul2(mul2(2.0,lmu),add2(vx_x2,vy_y2)));
