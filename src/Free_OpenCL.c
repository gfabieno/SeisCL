...
int Free_OpenCL(struct modcsts * m, struct varcl ** vcl, struct modcstsloc ** mloc)  {
    ...
    for (d=0;d<m->num_devices;d++){
        ...
        if ((*vcl)){
            ...
            if ((*vcl)[d].kernel_fill_transfer_buff_v_out) clReleaseKernel((*vcl)[d].kernel_fill_transfer_buff_v_out);
            if ((*vcl)[d].kernel_fill_transfer_buff_v_in) clReleaseKernel((*vcl)[d].kernel_fill_transfer_buff_v_in);
            if ((*vcl)[d].kernel_fill_transfer_buff_s_out) clReleaseKernel((*vcl)[d].kernel_fill_transfer_buff_s_out);
            if ((*vcl)[d].kernel_fill_transfer_buff_s_in) clReleaseKernel((*vcl)[d].kernel_fill_transfer_buff_s_in);
            if ((*vcl)[d].kernel_adj_fill_transfer_buff_v_out) clReleaseKernel((*vcl)[d].kernel_adj_fill_transfer_buff_v_out);
            if ((*vcl)[d].kernel_adj_fill_transfer_buff_v_in) clReleaseKernel((*vcl)[d].kernel_adj_fill_transfer_buff_v_in);
            if ((*vcl)[d].kernel_adj_fill_transfer_buff_s_out) clReleaseKernel((*vcl)[d].kernel_adj_fill_transfer_buff_s_out);
            if ((*vcl)[d].kernel_adj_fill_transfer_buff_s_in) clReleaseKernel((*vcl)[d].kernel_adj_fill_transfer_buff_s_in);
            ...
            if ((*vcl)[d].program_fill_transfer_buff_v_out) clReleaseProgram((*vcl)[d].program_fill_transfer_buff_v_out);
            if ((*vcl)[d].program_fill_transfer_buff_v_in) clReleaseProgram((*vcl)[d].program_fill_transfer_buff_v_in);
            if ((*vcl)[d].program_fill_transfer_buff_s_out) clReleaseProgram((*vcl)[d].program_fill_transfer_buff_s_out);
            if ((*vcl)[d].program_fill_transfer_buff_s_in) clReleaseProgram((*vcl)[d].program_fill_transfer_buff_s_in);
            if ((*vcl)[d].program_adj_fill_transfer_buff_v_out) clReleaseProgram((*vcl)[d].program_adj_fill_transfer_buff_v_out);
            if ((*vcl)[d].program_adj_fill_transfer_buff_v_in) clReleaseProgram((*vcl)[d].program_adj_fill_transfer_buff_v_in);
            if ((*vcl)[d].program_adj_fill_transfer_buff_s_out) clReleaseProgram((*vcl)[d].program_adj_fill_transfer_buff_s_out);
            if ((*vcl)[d].program_adj_fill_transfer_buff_s_in) clReleaseProgram((*vcl)[d].program_adj_fill_transfer_buff_s_in);
