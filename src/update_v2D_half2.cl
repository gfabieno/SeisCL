...
//        float2 lrkp = __half22float2(rkp(gidz,gidx));
        ...
        lvx.x = ((sxx_x.x + sxz_z.x)/lrip.x)*1000000000000.0;
        lvx.y = ((sxx_x.y + sxz_z.y)/lrip.y)*1000000000000.0;
        lvz.x = ((szz_z.x + sxz_x.x)/lrkp.x)*1000000000000.0;
        lvz.y = ((szz_z.y + sxz_x.y)/lrkp.y)*1000000000000.0;
