...
//    }
    ...
    __cprec lsxz=add2(lsxz,mul2(lmuipkp,add2(vx_z1,vz_x1)));
    __cprec lsxx=sub2(add2(lsxx,mul2(lM,add2(vx_x2,vz_z2))),mul2(mul2(f2h2(2.0),lmu),vz_z2));
    __cprec lszz=sub2(add2(lszz,mul2(lM,add2(vx_x2,vz_z2))),mul2(mul2(f2h2(2.0),lmu),vx_x2));
