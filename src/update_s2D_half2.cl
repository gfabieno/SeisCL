...
#define lidx gidx
    ...
    lsxz=add2(lsxz,mul2(lmuipkp,add2(vxz,vzx)));
    lsxx=sub2(add2(lsxx,mul2(lM,add2(vxx,vzz))),mul2(mul2(f2h2(2.0),lmu),vzz));
    lszz=sub2(add2(lszz,mul2(lM,add2(vxx,vzz))),mul2(mul2(f2h2(2.0),lmu),vxx));
